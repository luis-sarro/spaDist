...
# Added by Luisma because pro was longer than cdts!
pro = pro[idx]
...
if model == "KingMS":
	from ModelsCtr.KingMS import Module,Number,Density
	#--------- Initial parameters --------------
	namepar = ["$r_c$", "$r_t$", "slope"]
	mins    = np.array(([ 0.0, 10.0,-0.1]))
	maxs    = np.array(([ 5.0, 50.0,1.0]))
